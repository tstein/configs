...
alias lsdsk='lsblk -d -x MODEL -o NAME,TRAN,MODEL,SERIAL,SIZE,LOG-SEC,PHY-SEC,MQ,RQ-SIZE,SCHED'
alias lsfs='lsblk --tree -x NAME -o NAME,TRAN,MODEL,SERIAL,LABEL,FSTYPE,TRAN,SIZE,MOUNTPOINTS'
alias mtr='mtr -z'
